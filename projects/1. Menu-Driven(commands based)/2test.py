...
while True:  
	...
	# note: trying to develop the same for the windows commands to
		...
		# system operations or applicaitons
		...
		# web applications
		elif((('facebook' in user_input) or ('fb' in user_input) or ('face book')) and (('chrome' in user_input) or ('google chrome' in user_input) or ('googlechrome' in user_input) or ('google' in user_input))):
			os.system('google-chrome  facebook.com')
		elif((('facebook' in user_input) or ('fb' in user_input) or ('face book')) and (('firefox' in user_input) or ('fire fox' in user_input))):
			os.system('firefox facebook.com')


		elif((('instagram' in user_input) or ('insta gram' in user_input) or ('ig' in user_input) or ('insta' in user_input)) and (('chrome' in user_input) or ('google chrome' in user_input) or ('googlechrome' in user_input) or ('google' in user_input))):
			os.system('google-chrome instagram.com')
		elif((('instagram' in user_input) or ('insta gram' in user_input) or ('ig' in user_input) or ('insta' in user_input)) and (('firefox' in user_input) or ('fire fox' in user_input))):
			os.system('firefox instagram.com')

		
		elif((('linkedin' in user_input) or ('linked in' in user_input)) and (('chrome' in user_input) or ('google chrome' in user_input) or ('googlechrome' in user_input) or ('google' in user_input))):
			os.system('google-chrome likedin.com')	
		elif((('linkedin' in user_input) or ('linked in' in user_input)) and (('firefox' in user_input) or ('fire fox' in user_input))):
			os.system('firefox likedin.com')


		# launchs github (chrome/ firefox)
		elif((('github' in user_input) or ('git hub' in user_input) or ('git' in user_input)) and (('chrome' in user_input) or ('google chrome' in user_input) or ('googlechrome' in user_input) or ('google' in user_input))):
			os.system('google-chrome github.com')
		elif((('github' in user_input) or ('git hub' in user_input) or ('git' in user_input))  and (('firefox' in user_input) or ('fire fox' in user_input))):
			os.system('firefox github.com')


		# launchs gmail (chrome/ firefox)
		elif((('gmail' in user_input) or ('g mail' in user_input)) and (('chrome' in user_input) or ('google chrome' in user_input) or ('googlechrome' in user_input) or ('google' in user_input))):
			os.system('google-chrome gmail.com')
		elif((('gmail' in user_input) or ('g mail' in user_input)) and (('firefox' in user_input) or ('fire fox' in user_input))):
			os.system('firefox gmail.com')

		# launchs discord (chrome/ firefox)
		elif((('discord' in user_input) or ('discord channel' in user_input)) and (('chrome' in user_input) or ('google chrome' in user_input) or ('googlechrome' in user_input) or ('google' in user_input))):
			os.system('google-chrome discord.com')
		elif((('discord' in user_input) or ('discord channel' in user_input)) and (('firefox' in user_input) or ('fire fox' in user_input))):
			os.system('firefox discord.com')


		# launchs slack (chrome/ firefox)
		elif((('slack' in user_input) or ('slack channel' in user_input)) and (('chrome' in user_input) or ('google chrome' in user_input) or ('googlechrome' in user_input) or ('google' in user_input))):
			os.system('google-chrome slack.com')
		elif((('slack' in user_input) or ('slack channel' in user_input)) and (('firefox' in user_input) or ('fire fox' in user_input))):
			os.system('firefox slack.com')

		# launchs youtube (chrome/ firefox)
		elif((('youtube' in user_input) or ('you tube' in user_input) or ('u tube' in user_input)) and (('chrome' in user_input) or ('google chrome' in user_input) or ('googlechrome' in user_input) or ('google' in user_input))):
			os.system('google-chrome youtube.com')
		elif((('firefox' in user_input) or ('fire fox' in user_input)) and (('firefox' in user_input) or ('fire fox' in user_input))):
			os.system('firefox youtube.com')

		# launchs wikipedia (chrome/ firefox)
		elif((('wikipedia' in user_input) or ('wiki' in user_input)) and (('chrome' in user_input) or ('google chrome' in user_input) or ('googlechrome' in user_input) or ('google' in user_input))):
			os.system('google-chrome en.wikipedia.org')
		elif((('firefox' in user_input) or ('fire fox' in user_input)) and (('firefox' in user_input) or ('fire fox' in user_input))):
			os.system('firefox en.wikipedia.org')

		# launchs reddit (chrome/ firefox)
		elif((('reddit' in user_input) or ('red dit' in user_input)) and (('chrome' in user_input) or ('google chrome' in user_input) or ('googlechrome' in user_input) or ('google' in user_input))):
			os.system('google-chrome reddit.com')
		elif((('firefox' in user_input) or ('fire fox' in user_input)) and (('firefox' in user_input) or ('fire fox' in user_input))):
			os.system('firefox reddit.com')

		# launchs pinterest (chrome/ firefox)
		elif((('pinterest' in user_input)) and (('chrome' in user_input) or ('google chrome' in user_input) or ('googlechrome' in user_input) or ('google' in user_input))):
			os.system('google-chrome pinterest.com')
		elif((('firefox' in user_input) or ('fire fox' in user_input)) and (('firefox' in user_input) or ('fire fox' in user_input))):
			os.system('firefox pinterest.com')

		# launchs google play store (chrome/ firefox)
		elif((('play store' in user_input) or ('google play store'in user_input) or ('playstore' in user_input)) and (('chrome' in user_input) or ('google chrome' in user_input) or ('googlechrome' in user_input) or ('google' in user_input))):
			os.system('google-chrome play.google.com')
		elif((('firefox' in user_input) or ('fire fox' in user_input)) and (('firefox' in user_input) or ('fire fox' in user_input))):
			os.system('firefox play.google.com')

		# launchs quora (chrome/ firefox)
		elif((('quora' in user_input)) and (('chrome' in user_input) or ('google chrome' in user_input) or ('googlechrome' in user_input) or ('google' in user_input))):
			os.system('google-chrome quora.com')
		elif((('firefox' in user_input) or ('fire fox' in user_input)) and (('firefox' in user_input) or ('fire fox' in user_input))):
			os.system('firefox quora.com')

		# launchs flipkart(chrome/ firefox)
		elif((('flipkart' in user_input) or ('flip kart'in user_input)) and (('chrome' in user_input) or ('google chrome' in user_input) or ('googlechrome' in user_input) or ('google' in user_input))):
			os.system('google-chrome flipkart.com')
		elif((('firefox' in user_input) or ('fire fox' in user_input)) and (('firefox' in user_input) or ('fire fox' in user_input))):
			os.system('firefox flipkart.com')

		# launchs amazon (chrome/ firefox)
		elif((('amazon' in user_input)) and (('chrome' in user_input) or ('google chrome' in user_input) or ('googlechrome' in user_input) or ('google' in user_input))):
			os.system('google-chrome amazon.com')
		elif((('firefox' in user_input) or ('fire fox' in user_input)) and (('firefox' in user_input) or ('fire fox' in user_input))):
			os.system('firefox amazon.com')

		# launchs chrome
		elif(('chrome' in user_input) or ('google chrome' in user_input) or ('googlechrome' in user_input) ('google' in user_input)):
